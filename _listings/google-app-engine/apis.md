...
- name: Google App Engine Admin API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-app-engine/master/_listings/google-app-engine/v1-apps-appsid-repair-post.md
x-common:
- type: x-code-page
